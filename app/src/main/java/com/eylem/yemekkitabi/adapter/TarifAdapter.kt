package com.eylem.yemekkitabi.adapter

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.navigation.Navigation
import androidx.recyclerview.widget.RecyclerView
import com.eylem.yemekkitabi.databinding.RecyclerRowBinding
import com.eylem.yemekkitabi.model.Tarif
import com.eylem.yemekkitabi.view.ListeFragmentDirections
...
class TarifAdapter( val tarifListesi : List<Tarif>) : RecyclerView.Adapter<TarifAdapter.TarifHolder>() {
    ...
    override fun onBindViewHolder(holder: TarifHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val action = ListeFragmentDirections.actionListeFragmentToTarifFragment(bilgi = "eski",
